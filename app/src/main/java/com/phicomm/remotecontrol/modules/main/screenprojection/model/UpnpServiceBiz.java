...
import com.phicomm.remotecontrol.modules.main.screenprojection.callback.UpnpActionCallback;
import com.phicomm.remotecontrol.modules.main.screenprojection.listener.UpnpRegistryListener;
import com.phicomm.remotecontrol.modules.main.screenprojection.service.UpnpDeviceService;
...
public class UpnpServiceBiz {
    ...
    public static UpnpServiceBiz newInstance() {
        if (localUpnpService == null) {
            localUpnpService = new UpnpServiceBiz(BaseApplication.getApplication());
        }
    ...
    public void search() {
        for (Map.Entry<UDN, LocalDevice> entry : localDevices.entrySet()) {
