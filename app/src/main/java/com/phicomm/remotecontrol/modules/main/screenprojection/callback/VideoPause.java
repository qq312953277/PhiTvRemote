 ...
 */
public abstract class VideoPause extends UpnpActionCallback {
    private static String TAG = VideoPause.class.getSimpleName();

    public VideoPause(UnsignedIntegerFourBytes instanceId, Service service) {
    ...
    public void received(ActionInvocation invocation, Map<String, Object> result) {
        onSuccess("VideoPause play successful");
    }
